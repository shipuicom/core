...
import { SparkleStickyColumnsDirective, SparkleTableComponent } from '../../../../../../../sparkle-ui/src/public-api';
...
@Component({
  ...
  standalone: true,
  imports: [SparkleTableComponent, SparkleStickyColumnsDirective],
  templateUrl: './multi-sticky-table.component.html',
  styleUrl: './multi-sticky-table.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class MultiStickyTableComponent {
  type = input<string>();
