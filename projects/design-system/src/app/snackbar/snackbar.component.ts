...
import { SparkleAlertModule, SparkleAlertService } from '@sparkle-ui/core';

@Component({
  selector: 'app-snackbar',
  standalone: true,
  imports: [MatSnackBarModule, MatIconModule, MatButtonModule, MatDividerModule, SparkleAlertModule],
